	...
	public class Welcome {
		...
		public class RandomImage{
			...
			public class RandomSinaImage{
				public String random_Image_URLs = "https://acg.toubiec.cn/random|http://www.dmoe.cc/random.php|http://api.mtyqx.cn/tapi/random.php|http://api.mtyqx.cn/api/random.php";
			}
